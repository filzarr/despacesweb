...
const Blogopen = () => {
    return (
        <div className="">
            ...
            <section className="blog-single-sec section-padding">
                <div className="container">
                            ...
                            <div className="col-lg-8">
                                <div className="blog-single-post single">
                                        ...
                                        <div className="row">
                                            <div className="col-lg-6">
                                                <div className="blg-sm">
                                                    <img src="https://via.placeholder.com/388x344" alt=""/>
                                                </div> 
                                            </div>
                                            <div className="col-lg-6">
                                    ...
                                    <div className="post-share">
                                        ...
                                        <a href="#comment-sec" title="">Write A Comment <i className="la la-arrow-right"></i></a>
                                    </div> 
                                ...
                                <div className="comment-section">
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <a href="#" title="" className="cm-reply">Reply</a>
                                        </li>
                                        <li>
                                            <div className="cm-info-sec">
                                                <div className="cm-img">
